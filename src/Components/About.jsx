...
function About() {
  return (
    ...
    <div className="about-content">
      ...
      <h2 className="heading secondary-heading">Skills</h2>
      ...
      <h2 className="current secondary-heading">Currently: </h2>
      <p className="current">I am making new projects with the MERN stack, taking Harvard's CS50 course, grinding leetcode and probably having a coffee.</p>
      </div>
    </div>
  );
}
